...
const _cfgPath = `${_path}/plugins/sims-plugin/model/`
let cfg = {}

let configPath = `${_path}/plugins/sims-plugin/config/`
let defSetPath = './plugins/sims-plugin/defSet/'
