...
import fs from 'fs'
import { Cfg, Version, Common, Data } from '../model/index.js'
import Theme from './help/theme.js'

const _path = process.cwd()
const helpPath = `${_path}/plugins/sims-plugin/resources/help`
...
export class Help extends plugin {
  constructor() {
    super({
      ...
      rule: [
        {
          reg: "^#?模拟人生?(命令|帮助|菜单|help|说明|功能|指令|使用说明)$",
          fnc: 'help'
        },
        {
          reg: "^#?模拟人生版本$",
  ...
  async help(e) {
    if ((!/模拟人生/.test(e.msg)) && !Cfg.get('sys.help', false)) {
      return false
    }
